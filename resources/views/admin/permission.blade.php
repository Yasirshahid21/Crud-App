...
@include ('admin.permission_modal')
<div class="row">
    <div class="col-md-3">
    ...
    <div class="col-md-8 mt-5 justify-content-start">
        ...
        <div class="row">
            ...
            <div class="col-md-2 py-4 text-right">
                <button type="button" class="btn btn-primary text-right" data-toggle="modal" data-target="#permission">
                    Add New
                </button>
            </div>
                    ...
                    @foreach ($permissions as $permission)
                        <tr>
                            ...
                            <td class="d-flex">
                                ...
                                <form class="ml-1" action="{{ route('permissions.destroy', $permission->id) }}"
                                    method="POST">
                                    @csrf @method('DELETE')
                                    <input type="hidden">
